class PuppetGem < FPM::Cookery::Recipe
  ...
  def build
    ...
    gem_install 'unicorn',            '4.9.0'
    gem_install 'rack',               '1.6.4'
    gem_install 'pg',                 '0.18.3'
    gem_install 'bundler',            '1.10.6'
    gem_install 'librarian-puppet',   '2.2.1'
    gem_install 'net-ldap',           '0.11'
